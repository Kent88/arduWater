...
// alerting when the total flowed through in on a certain interval
...
#define MAX_COUNT 62 //volume of water to dispense in instances in "counts" or "pulses"
...
{ 
  ...
  */
  ...
  {
    Serial.print(pulseCount / MAX_COUNT);
    Serial.println(" cups dispensed");
    pulseInterval += MAX_COUNT;
  }//if
} 
